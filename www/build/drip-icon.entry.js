import { r as registerInstance, h, d as getElement } from './chunk-6f71c0ca.js';
import { L as Lottie } from './chunk-98b1e9d1.js';
...
class DripIcon {
    ...
    static get style() { return "drip-icon {\n  -ms-flex-item-align: center;\n  align-self: center;\n  justify-self: center;\n\n  width: 36px;\n  fill: var(--color-secondary);\n}\ndrip-icon path {\n  fill: var(--color-secondary);\n}\n\@media screen and (max-width: 420px) {\n  drip-icon {\n    grid-column: 3;\n    grid-row: span 2 / 2;\n  }\n}"; }
}

export { DripIcon as drip_icon };
