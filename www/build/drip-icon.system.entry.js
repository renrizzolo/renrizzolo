System.register(['./chunk-504aaad5.system.js', './chunk-6c5b132b.system.js'], function (exports) {
    'use strict';
    var registerInstance, h, getElement, lottie;
    return {
        ...
        execute: function () {
            var DripIcon = /** @class */ (function () {
                function DripIcon(hostRef) {
                    registerInstance(this, hostRef);
                }
                DripIcon.prototype.watchPlay = function (o, _) {
                    o === true ? this.animation && this.animation.play() : this.animation && this.animation.pause();
                };
                DripIcon.prototype.componentDidLoad = function () {
                    ...
                    var container = this.el.getElementsByClassName('drip');
                ...
                DripIcon.prototype.componentWillUnload = function () {
                    lottie.destroy();
                };
                DripIcon.prototype.render = function () {
                    return (h("div", { id: "drip", class: "drip" }));
                };
                Object.defineProperty(DripIcon.prototype, "el", {
                    get: function () { return getElement(this); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(DripIcon, "watchers", {
                    get: function () {
                        return {
                            "play": ["watchPlay"]
                        };
                ...
                Object.defineProperty(DripIcon, "style", {
                    get: function () { return "drip-icon {\n  -ms-flex-item-align: center;\n  align-self: center;\n  justify-self: center;\n\n  width: 36px;\n  fill: var(--color-secondary);\n}\ndrip-icon path {\n  fill: var(--color-secondary);\n}\n\@media screen and (max-width: 420px) {\n  drip-icon {\n    grid-column: 3;\n    grid-row: span 2 / 2;\n  }\n}"; },
                    enumerable: true,
                    configurable: true
                });
                return DripIcon;
            }());
            exports('drip_icon', DripIcon);
        }
    };
});
